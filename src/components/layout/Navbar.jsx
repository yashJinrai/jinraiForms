    ...
    return (
        <header className="h-20 bg-white border-b border-slate-100 flex items-center justify-between px-4 sm:px-8 sticky top-0 z-40">
            ...
            <button 
                ...
                className="lg:hidden p-2 mr-2 text-slate-500 hover:bg-slate-50 rounded-xl transition-all"
            >
                <Menu size={24} />
            </button>
            ...
            <div className="flex items-center gap-6">
                ...
                <button 
                    ...
                    className="relative p-2.5 bg-slate-50 text-slate-500 hover:text-[#3713ec] hover:bg-[#3713ec]/5 rounded-xl transition-all group"
                >
                    <Bell size={22} />
                    {unreadCount > 0 && (
                ...
                {!loading && (
                    <div className="relative">
                        <div
                            ...
                            className="flex items-center gap-4 pl-6 border-l border-slate-100 hover:opacity-80 transition-opacity cursor-pointer"
                        >
                            ...
                            <ChevronDown className={`text-slate-400 transition-transform ${showDropdown ? 'rotate-180' : ''}`} size={16} />
                        </div>

                        {/* Dropdown Menu */}
                        {showDropdown && (
                            <div className="absolute right-0 mt-2 w-48 bg-white border border-slate-100 rounded-2xl shadow-xl py-2 z-50 animate-in fade-in slide-in-from-top-2">
                                <NavLink
                                    to="/profile"
                                    className="flex items-center gap-3 px-4 py-2 text-sm font-bold text-slate-600 hover:bg-slate-50 hover:text-[#3713ec] transition-all"
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center gap-3 px-4 py-2 text-sm font-bold text-red-500 hover:bg-red-50 transition-all"
                                >
                                    <LogOut size={16} />
                                    Logout
                                </button>
